...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or krugercoind the wallet will be rewritten, Bitcoin will
...
krugercoind: run the 'walletpassphrase' RPC command to unlock the wallet,  then run the 'getnewaddress' RPC command.
