...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKrugercoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KrugercoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKrugercoinURI(info));
}
