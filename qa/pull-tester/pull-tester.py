...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old KrugercoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/KrugercoindComparisonTool_jar/KrugercoindComparisonTool.jar 0 6 ${OUT_DIR}"
